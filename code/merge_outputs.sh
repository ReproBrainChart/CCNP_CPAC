#!/bin/bash
set -e -u -x
outputsource=ria+file:///cbica/projects/RBC/production/CCNP/c-pac-1.8.5/output_ria#280be2de-eeda-46a4-8f1f-94eca224e9b0
cd /cbica/projects/RBC/production/CCNP/c-pac-1.8.5
